...
export default function PatrimonyMaintenanceDocumentList() {
  ...
  useEffect(() => {
    ...
    apiClient
      .get(`/PatrimonyMaintenance/${guid}/documents`)
  ...
  return (
    <>
      <PageMeta
        title="Documentos da Manutenção"
        description="Lista de documentos do patrimônio"
      />
      ...
      <PageBreadcrumb
        items={[
          ...
          {
            label: "Documentos",
            path: `/manutencoes-patrimonios/${guid}/documentos`,
          },
        ]}
      />
      ...
      <div className="space-y-6">
        <ComponentCard title="Documentos da Manutenção">
