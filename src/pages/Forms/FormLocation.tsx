...
import { LocationDTO } from "@/types/Department/LocationDTO";
import useGoBack from "@/hooks/useGoBack";

type Props = {
  initialData?: LocationDTO;
  onSubmit: (data: LocationDTO) => Promise<void>;
};

export default function FormLocation({ initialData, onSubmit }: Props) {
