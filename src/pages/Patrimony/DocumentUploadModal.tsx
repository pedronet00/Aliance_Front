...
import { showErrorToast, showEditedSuccessfullyToast, showCreatedSuccessfullyToast } from "@/components/toast/Toasts";
import apiClient from "@/api/apiClient";

interface UploadDocumentModalProps {
  patrimonyGuid: string;
  onClose: () => void;
}

const UploadDocumentModal: FC<UploadDocumentModalProps> = ({ patrimonyGuid, onClose }) => {
  ...
  const handleUpload = async () => {
    ...
    setLoading(true);
    try {
      await apiClient.post(`/Patrimony/${patrimonyGuid}/documents`, formData, {
